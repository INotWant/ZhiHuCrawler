...
public class VAnswerPageProcess implements PageProcessor {
    ...
    public VAnswerPageProcess(String cookie) {
        site = Site
                .me()
                .setTimeOut(10000)
    ...
    public void process(Page page) {
        ...
        if (url.matches("^(https://www.zhihu.com/api/).*")) {
            ...
            for (int i = 0; i < answerList.size(); i++) {
                page.addTargetRequest(new Request("https://www.zhihu.com/question/" + questionList.get(i) + "/answer/" + answerList.get(i)).setPriority(Long.MAX_VALUE));
            }
            ...
            for (int i = 0; i <= answerTotalNum / 20; i++) {
                ...
                offset += 20;
                page.addTargetRequest(new Request(jsonUrl).setPriority(Long.MAX_VALUE - 1));
            }
        } else {
            VUser vUser = null;
